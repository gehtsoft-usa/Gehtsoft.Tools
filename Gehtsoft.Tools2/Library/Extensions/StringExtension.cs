...
namespace Gehtsoft.Tools2.Extensions
{
    ...
    {
        /// <summary>
        /// Performs equality checking using behavior similar to that of SQL's LIKE.
        /// </summary>
        ...
        /// </remarks>
        public static bool Like(this string text, string mask, bool caseInsensitive = true)
        {
                ...
                else
                {
                    ...
                    if (mask[i] == '[')
                    {
                        ...
                        if (multicharmask.Length == 3 && multicharmask[1] == '-')
                        {
                            ...
                            multicharmask = newmask.ToString();
                        }
